...
- Added new Kusto query custlogtext_winux_int

## [7.3.1] - 2026-07-21

### Fixed

- Fixed action group configuration to use the correct URI. 

## [7.3.0] - 2026-07-21

### Added

- Added new Action Group EventPipelineForwarder_AG_2.
...
- To include all selected_events from active directory, managed OS and SQL.
...
- Added one new Kusto query.

## [6.9.0] - 2026-03-13

### Added

- Added two new columns (Computer & Filepath) to custom_logs.tf locals block.

## [6.8.5] - 2026-02-05

### Fixed

- Fixed managed identity block, moving dynamic block.

## [6.8.4] - 2026-02-05

### Fixed

- Fixed managed identity block, adding a dynamic block in main.tf file.
