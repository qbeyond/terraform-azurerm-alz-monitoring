...
| <a name="input_reservations"></a> [reservations](#input\_reservations) | NOTE: Optionally deploying reservations monitoring requires you to manually give the Automation Account "Reservation Reader" permissions in the tenant. | <pre>object({<br/>    enabled = bool<br/>    emails  = list(string)<br/>  })</pre> | <pre>{<br/>  "emails": [],<br/>  "enabled": false<br/>}</pre> | no |
...
| <a name="input_secret_forwarder_2"></a> [secret\_forwarder\_2](#input\_secret\_forwarder\_2) | Value that will replace the placeholder `{{secret}}` in `event_pipeline_config.service_uri_forwarder_2`. | `string` | `""` | no |
...
## Resource types
      ...
      |------|-------|
        ...
        | [azurerm_automation_job_schedule](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/automation_job_schedule) | 2 |
        | [azurerm_automation_module](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/automation_module) | 3 |
        | [azurerm_automation_runbook](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/automation_runbook) | 2 |
        | [azurerm_automation_schedule](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/automation_schedule) | 2 |
        ...
        | [azurerm_monitor_action_group](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_action_group) | 6 |
        ...
        | [azurerm_monitor_scheduled_query_rules_alert_v2](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_scheduled_query_rules_alert_v2) | 2 |
        ...
        | [time_static](https://registry.terraform.io/providers/hashicorp/time/latest/docs/resources/static) | 2 |
...
No modules.
        ...
        ## Resources by Files
            ...
            |------|------|
                  ...
                  | [azurerm_monitor_action_group.forwarder_2](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_action_group) | resource |
            ...
            | Name | Type |
            |------|------|
                  | [azurerm_automation_job_schedule.reservations_to_law](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/automation_job_schedule) | resource |
                  | [azurerm_automation_module.az_reservations](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/automation_module) | resource |
                  | [azurerm_automation_runbook.reservations_to_law](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/automation_runbook) | resource |
                  | [azurerm_automation_schedule.once_monthly](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/automation_schedule) | resource |
                  | [azurerm_monitor_action_group.reservationexpiry](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_action_group) | resource |
                  | [azurerm_monitor_scheduled_query_rules_alert_v2.reservationexpiry](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/monitor_scheduled_query_rules_alert_v2) | resource |
                  | [time_static.monthly_start](https://registry.terraform.io/providers/hashicorp/time/latest/docs/resources/static) | resource |
