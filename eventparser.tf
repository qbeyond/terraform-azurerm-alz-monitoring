resource "azurerm_resource_group_template_deployment" "terraform-test" {
  ...
  parameters_content = jsonencode({
    ...
    "logicapp_uri" = {
      value = "https://import-azure-alerts-function-app.azurewebsites.net/api/GenericWebhookJS1?code=${var.event_pipeline_key}&clientid=fctkey-${customer_code}-prd-eventpipeline-01" # TODO: vorher: REDACTED
    }
  })
}
